...
import { Building2, User, Mail, Lock, MessageSquare, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="w-full max-w-md px-4 animate-fade-in">
        ...
        <div className="glass rounded-2xl p-8 shadow-2xl shadow-black/20">
          <h2 className="text-xl font-semibold text-center mb-1 text-gray-900">Create your account</h2>
          <p className="text-sm text-center text-gray-500 mb-6">Get started with Tarun</p>
